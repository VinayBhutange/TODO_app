    ...
    const toDoList = this.state.items.map((item, index) =>
      <div key={index} className="todo-list-item">
        ...
        <span className="todo-list-item-edit-option">
          <input type="button" id="btn-edit" name="btn-edit" onClick={() => { this.EditItem(index) }} class= "b2" value="Edit" />
          <input type="button" id="btn-delete" name="btn-delete" onClick={() => { this.DeleteItem(index) }} class="b2" value="Delete" />
        </span>
      ...
      <div className="todo-app">
        ...
        <div className="todo-add-save-section">
          ...
          {this.state.edit === false ? (
            <input type="button" id="btn-add" name="btn-add" onClick={this.AddNewItem} class="b2" value="ADD" />
          ) : (
